...
<form action='${pageContext.request.contextPath}/change_bank_account_form/set_min_balance' method="post">
         ...
         <input type="text" id="orgID" name="orgID" value='${bank_account.organisation.id}' hidden required>
           ...
           value='${bank_account.minAllowedBalance}'  pattern="-?\d+(.\d*)?" required>
...
<form action='${pageContext.request.contextPath}/change_bank_account_form/set_block' method="post">
   ...
   <input type="text" id="orgID" name="orgID" value='${bank_account.organisation.id}' hidden >
         <input type="text" id="block" name="block" value='false' hidden>
 ...
 <form action='${pageContext.request.contextPath}/change_bank_account_form/set_block' method="post">
    ...
    <input type="text" id="orgID" name="orgID" value='${bank_account.organisation.id}' hidden >
          <input type="text" id="block" name="block" value='true' hidden>
...
<form action='${pageContext.request.contextPath}/change_bank_account_form/set_info' method="post">
  ...
  <input type="text" id="orgID" name="orgID" value='${bank_account.organisation.id}' hidden required>
            <label for="orgInfo">информация: </label> <input type="text" value = '${bank_account.info}' id="orgInfo" name="orgInfo" pattern="[\wА-Яа-я\s:!.,)(-?\d]+" required>
 <input type="submit" value="установить">
            </form>
